...
export default function BalancePage() {
  ...
  const topUpMutation = useMutation({
    ...
    onSuccess: (data) => {
      if (data?.payment_url) {
        ...
        toast.error(
          'Payment initialization succeeded, but redirect URL was missing.'
        );
      }
    },
    onError: (err: Error) => {
  ...
  const balance =
    balanceData?.balance !== undefined ? Number(balanceData.balance) : 0.0;
          ...
          <CardContent className="relative z-10 space-y-6">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-2">
                Funds are automatically debited for request completions and
                credited for fulfillments.
              </p>
            </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-foreground font-medium mt-0.5">
                    Enabled for all coordination operations
                  </div>
                </div>
              </div>
            </div>
      ...
      <Card className="border-border bg-card shadow-sm">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
          <div>
            ...
            <CardDescription className="text-xs text-muted-foreground">
              Audit log of all financial activities.
            </CardDescription>
          </div>
